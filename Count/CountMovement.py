...
def get_track(track_items, region ,min_length = 0.3,stride=1, gaussian_std = 0.3,speed_window=1,min_speed=10):
    ...
    #region = np.loadtxt(roi_path, delimiter=',',dtype=np.int)   #dsvvvfdvfdvdfvdfvfdvsdcdjahsvbhvbfhvbdfvbdfhbvjhdfbvhjfdbvdkfhjb
...
def main(_argv):
    ...
    if FLAGS.visualize == True:
        ...
        visualize(list_obj,results_path,TRACKING_RESULT_PATH,video_path,output_path,region,movement)
